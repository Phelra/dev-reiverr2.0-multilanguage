...
export async function searchSeriesMedia(
	...
	try {
		if ((episode == null || episode === 0) && !monitored) {
			console.log('Processing full season without monitoring');
			...
			console.log('Monitoring and downloading full season');
			...
			console.log('Monitoring and downloading specific episode');
